...
<link id="skinUri" rel="stylesheet" type="text/css"
	href="<w:path/>resources/css/main.css">
...
<script type="text/javascript"
	src="<w:path/>resources/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="<w:path/>resources/js/pagination.js"></script>
<script type="text/javascript"
	src="<w:path/>resources/js/jquery.validate.min.js"></script>
<script type="text/javascript"
	src="<w:path/>resources/js/jquery.cookie.js"></script>
<!--[if lt IE 9]>
